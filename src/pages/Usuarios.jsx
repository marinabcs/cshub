...
import { ArrowLeft, Users, Plus, Pencil, Trash2, Key, Shield, ShieldCheck, Eye, X, AlertTriangle, Check } from 'lucide-react';

const ROLES = {
  viewer: { label: 'Visualizador', description: 'Apenas leitura', color: '#64748b', icon: Eye },
  admin: { label: 'Admin', description: 'Gerencia usuários', color: '#8b5cf6', icon: Shield },
  super_admin: { label: 'Super Admin', description: 'Acesso total', color: '#f59e0b', icon: ShieldCheck }
};
...
export default function Usuarios() {
  ...
  const canManageUsers = () => {
    return currentUserRole === 'admin' || currentUserRole === 'super_admin' || user?.email === SUPER_ADMIN_EMAIL;
  };
  ...
  const openAddModal = () => {
    setModalMode('add');
    setFormData({ nome: '', email: '', senha: '', role: 'viewer' });
    setFormError('');
    setShowModal(true);
  };
                  ...
                  <tr key={usuario.id} style={{ borderBottom: '1px solid rgba(139, 92, 246, 0.05)' }}>
                    <td style={{ padding: '16px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                          <p style={{ color: 'white', fontSize: '14px', fontWeight: '500', margin: 0 }}>{usuario.nome || '-'}</p>
                    ...
                    <td style={{ padding: '16px', color: '#64748b', fontSize: '13px', textAlign: 'center' }}>
                    ...
                    return (
                      ...
                      >
                        <div style={{
                          ...
                          <RoleIcon style={{ width: '18px', height: '18px', color: value.color }} />
                        </div>
                        <div style={{ flex: 1 }}>
